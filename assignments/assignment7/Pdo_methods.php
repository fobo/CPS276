...
class PdoMethods extends DatabaseConn {
	...
	/*
Fatal error: Uncaught PDOException: SQLSTATE[HY093]: Invalid parameter number: parameter was not defined in /var/www/html/assignment7/Pdo_methods.php:79
 Stack trace: #0 /var/www/html/assignment7/Pdo_methods.php(79): PDOStatement->bindParam(':fname,', 'HELLODB', 2) 
 #1 /var/www/html/assignment7/Pdo_methods.php(57): PdoMethods->createBinding(Array) 
 #2 /var/www/html/assignment7/fileUploadProc.php(30): PdoMethods->otherBinded('INSERT INTO fil...', Array) 
 #3 /var/www/html/assignment7/addFiles.php(5): uploadFile->funcUpload(Array) 
 #4 {main} thrown in /var/www/html/assignment7/Pdo_methods.php on line 79
	*/
